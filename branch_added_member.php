...
if($user_role == 'branch' AND $session_branch_id == $branch_id){
	 
	  /*$sql1 = mysqli_query($con,"INSERT INTO `transaction_notification`(is_check_submitted,member_id,branch_id,source_branch,destination_branch)
	  VALUES('2','$memberId','$branch_id','$session_branch_id','$branch_id')"); */
	...
	/*$sql2 = mysqli_query($con,"INSERT INTO `transaction_notification`(is_check_submitted,is_payment_done,member_id,branch_id,source_branch,destination_branch)
	  VALUES('1','1','$memberId','$branch_id','$session_branch_id','$branch_id')");*/
