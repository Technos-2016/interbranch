...
$sql = mysqli_query($con,"UPDATE `transaction_notification` SET is_payment_done='1' where transaction_id='$notification_id'");  
...
if ($sql== TRUE) {
    echo json_encode(array("status"=>"success","message"=> "Payment Done."), 200); exit;
} else {
