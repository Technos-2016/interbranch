...
$live = $result->fetch_all(MYSQLI_ASSOC);
$_SESSION['live_status'] = $live[0]['live_status'];

$lives = $_SESSION['live_status'];

if ($lives == '0') {
    echo "<script>alert('please verify your token before proceeding..');window.location='token.php'</script>";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" ><?php if (isset($userid)) { ?> Welcome <?php echo $_SESSION['usr_name']; ?><span class="caret"></span></a>
...
<?php } ?>
        ...
        <div class="container-fluid">
            ...
            <header >
                ...
                <p class="text-center" >
                    <a class="btn btn-success btn-large " href="deposit.php" style="margin-right:30px">Deposit</a>
                    <a class="btn btn-primary btn-large" href="branch.php" style="margin-right:30px">Payment</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <h3 style="margin-left: 40px;font-size:13px;">List Of Online Staff</h3>
        ...
        <div class="modal fade" id="checkdepositeReject" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="" id="frm_deposite_reject" name="frm_deposite_reject" class="admin-form">
        ...
        <!-- <div class="modal fade" id="notify" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
             <div class="modal-dialog">
                 <div class="modal-content">
                     <div class="modal-header">
                         <h4 class="text-center">Notification From Head Office</h4>
                     </div>
                     <div class="modal-body text-success text-center"><b><span class="notify"></span></b></div>
                     <div class="modal-footer">
...
<?php include_once ('includes/footer.php'); ?>
        ...
        <script>
            /*function displayCheckDetail(member_id, branchid)
             {
             $.ajax({
             data: {'member_id': member_id, 'branch_id': branchid},
             type: 'POST',
             dataType: 'html',
             url: 'view_branch_notification.php',
             cache: false,
