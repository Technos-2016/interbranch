                        ...
                        <div class="row" style="padding-top:10px;">
                            <div class=" col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:bold;" >Transaction Branch : <?php
                                        if ($memberDetail[0]['source_branch'] != $memberDetail[0]['destination_branch']) {
...
<?php if ($memberDetail[0]['is_check_reject'] == 1) { ?>
        ...
        echo "Rejected By : " . $_SESSION['usr_name'];
    } ?></td>
                                    <td></td>
                                </tr>
<?php } else if ($memberDetail[0]['is_check_approve'] == 1) {
    ?>
                                <tr>
                                    ...
                                    <td style="font-weight:bold;" ><?php if (isset($_SESSION['usr_id'])) {
        echo "Approved By : " . $_SESSION['usr_name'];
    } ?></td>
                                    <td></td>
                                    <td></td>
    ...
    ?>
                                <tr>
                                    ...
                                    <td style="font-weight:bold;" ><?php if (isset($_SESSION['usr_id'])) {
        echo "Approver : " . $_SESSION['usr_name'];
    } ?></td>
                                </tr>
