...
<html>
    ...
    <body>
        ...
        <div class="container" style="margin-top:100px;">
            ...
            <div class="row" >
                <form action=""  method="post" name="frmHeadquarter" id="frmHeadquarter" class="" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 pull-left form-group em-form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 ">
                                ...
                                <input class="form-control " placeholder="Please Enter Bearer Name" id="payeename"  name="payeename" placeholder="Payee Name" required data-bv-notempty-message="Please enter payee name" title="Please Enter Bearer Name" type="text"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <br/>
                                <input class="form-control" placeholder="Please Enter Member Name" id="mname" maxlength="30" name="mname" placeholder="Member Name" required data-bv-notempty-message="Please enter member name" title="Please Enter Member Name" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-6">
                                <br/>
                                <input class="form-control" placeholder="Please Enter Member (123.12.2) / Center Code(123)" id="mcode" maxlength="8" name="mcode" placeholder="Please enter in the given format ###.##.# (#=Numbers)" required data-bv-notempty-message="Please enter in the given format ###.##.# (#=Numbers)" data-bv-regexp="true" data-bv-regexp-regexp="^\s*-?[0-9].{1,100}.\s*$" data-bv-regexp-message="Please enter in the given format ###.##.# (#=Numbers)" title="Please Enter Member (123.12.2) / Center Code(123)" type="text"  onkeyup="round_off(this.value)"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6"> 
                                <br/>
                                <input class="form-control" placeholder="Please Enter Amount From Cheque" id="amount" maxlength="7" name="amount" placeholder="Amount" required data-bv-notempty-message="Please enter amount" data-bv-regexp="true" data-bv-regexp-regexp="^\s*-?[0-9]{1,100}\s*$" data-bv-regexp-message="Please enter  only numbers." title="Please Enter Amount From Cheque" type="text" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4"> 
                                <br/>
                                <label for="Cheque">Cheque Number
                                </label>
                            </div>
                            <div class="col-sm-6"> 
                                <br/>
                                <input class="form-control" placeholder="Please Enter Cheque Number" id="mcheckno" maxlength="7" name="mcheckno" placeholder="Member Cheque Number" required data-bv-notempty-message="Please enter Cheque Number" data-bv-regexp="true" data-bv-regexp-regexp="^\s*-?[0-9]{1,100}\s*$" data-bv-regexp-message="Please enter  only numbers." title="Please Enter Cheque Number" type="text" />
                            </div>
                        </div>
...
//alert(mystring2);
                ...
                $('#previewBtn').click(function () {
                    ...
                    if (name > 1000000) {
                        alert('You can only make payment Upto 1000000');
                        return false;
                    }
                    if (isNaN(name)) {
