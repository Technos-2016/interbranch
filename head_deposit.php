...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="headquarter.php" >Home
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action=""  method="post" name="frmdeposit" id="frmdeposit" class="">
                        <div class="col-md-9 pull-left form-group em-form">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3">
                                    <br/> 
                                    <label for="Member Name">Spouse/Father In Law
                                    </label>
                                </div>
                                <div class="col-sm-8">
                                    <br/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <br/>
                                    <input type="text" name="member_code" id="member_code" placeholder="Please Enter Member (123.12.2) / Center Code(123)" class="form-control" maxlength="8" required data-bv-notempty-message="Please enter in the given format (000.00.0)" data-bv-regexp="true" data-bv-regexp-regexp="^\s*-?[0-9].{1,100}.\s*$" data-bv-regexp-message="Please enter in the given format (000.00.0)" onkeyup="round_off(this.value)" >
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-8">
                                    <br/>
                                    <select id="sel_branch" name="sel_branch" class="gui-input form-control" required data-bv-notempty-message="Please select branch." >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8"> 
                                    <br/>
                                    <input type="text" maxlength="7" placeholder="Please Enter amount in Number" name="amount" id="amount" class="form-control" required data-bv-notempty-message="Please enter Amount" data-bv-regexp="true" data-bv-regexp-regexp="^\s*-?[0-9]{1,100}\s*$" data-bv-regexp-message="Please enter  only numbers." >
                                </div>
                            </div>
                        </div>
                        <div class="row">
        ...
        <script>
            ...
            /*function addDecimalPoints(id) {
             ...
             /* for encountering dot after 3 digit and 2 digit*/
            ...
            //alert(mystring);
                ...
                if (mystring != "" && mystring.length > 3) {
                    document.getElementById("member_code").value = mystring4;
                     //mystring4.replace();
                }
                //document.getElementById("member_code").reset();
               
            }
             /* end of encountering dot after 3 digit and 2 digit*/
            ...
            $('#previewBtn').click(function () {
                ...
                if (name.length > 7) {
                    alert('Please enter less than 7 Digit');
                    return false;
                }
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        ...
                        if (json.status === 'failed') {
                            ...
                            alert(json.message);
                            window.location = "total_deposit_history_head.php";
                            //alert(json.message);
                            //location.reload();
