...
if ($radio == "Approved") {
    ...
    <table id="tblSearch" class="table table-striped table-condensed">
        ...
        <?php
        $status = "Approved";
        $query1 = "SELECT * FROM deposit as ds LEFT JOIN transaction_notification_depositor as trn ON (trn.member_id = ds.id) WHERE ds.source_branch_id='$branch_id' AND deposite_type='$status'ORDER BY date DESC";
    ...
    ?>
        ...
        header("Content-Deposition:attachment, filename:Approved.xls");
