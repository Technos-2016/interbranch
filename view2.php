        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
					...
					<a class="navbar-brand" href="index.php">JBS ABBS DEPOSIT</a>
                </div>
							...
							<table class="table data-table">
								...
								<tbody>
									<tr>
										...
										<td colspan="2"><img height='300' width='700' src="<?php echo $memberDetail[0]['check_image']?>"></td>
										<td></td>
									...
									<tr>
										...
										<td><?php echo $memberDetail[0]['branch_name'];?></td>
										...
										echo "<td class='check_amount'>". $branchName[0]["branch_name"]."</td>";
										}else {
											echo "------";
										}?>
									...
									<tr>
										...
										<td><?php echo $memberDetail[0]['member_name'];?></td>
										<td><?php echo $memberDetail[0]['member_code'];?></td>
										<td><?php echo $memberDetail[0]['member_check_number'];?></td>
										<td><?php echo $memberDetail[0]['amount'];?></td>
									
										<td><img height='150' width='150' src="images/member_profile_images/<?php //echo $memberDetail[0]['member_picture']?>"></td>
										<td colspan="2"><img height='150' width='250' src="<?php //echo $memberDetail[0]['check_image']?>"></td>
										<td></td>
									</tr>
									...
									<tr>
									  <td><input type="text" name="balance" id="balance" onchange="availableBalance();"></td>
										<td>
										 <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" id="balanceData" placeholder="Balance Calculation"></div>
										</td>
