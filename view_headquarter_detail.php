                    ...
                    <div class="pull-left form-group em-form" style="width:100%;">
					   ...
					   <div class="row" style="padding-top:10px;">
							   ...
							   <tr>
										...
										<td style="font-weight:bold;">Balance Remaining : <?php echo $memberDetail[0]['balance_amount']?></td>
										<td style="font-weight:bold;">Cheque Comment : <?php echo $memberDetail[0]['comment']?></td>
									
										 <td style="font-weight:bold;" ><?php if (isset($_SESSION['usr_id'])) {  echo "Rejected By : ". $_SESSION['usr_name'];} ?></td>
							   </tr>
							   <?php } 
							   ...
							   <tr>
										...
										<td style="font-weight:bold;">Balance Remaining : <?php echo $memberDetail[0]['balance_amount']?></td>
										 <td style="font-weight:bold;" ><?php if (isset($_SESSION['usr_id'])) {  echo "Approved By : ". $_SESSION['usr_name'];} ?></td>
										<td></td>
										<td></td>
							   ...
							   <tr>
										...
										<td style="font-weight:bold;">Balance Before Payment
											<input type="text" name="balance" id="balance" onchange="availableBalance();"></td>
